...
list_piecewise_in_control_piecewise_bootstrap <- list(threshold_values = store_threshold, proportion_in_control_signal = proportion_signals_in_control_estimated_vs_true)
saveRDS(list_piecewise_in_control_piecewise_bootstrap, "section_3_5/piecewise_constant_baseline/parametric_piecewise_constant_model/list_piecewise_in_control_piecewise_bootstrap_baseline_period.RDS")

# If the simulations have been performed

list_piecewise_in_control_piecewise_bootstrap <- readRDS("section_3_5/piecewise_constant_baseline/parametric_piecewise_constant_model/list_piecewise_in_control_piecewise_bootstrap_baseline_period.RDS")

df_piecewise_in_control_piecewise_bootstrap <- data.frame(proportion_in_control_signal = list_piecewise_in_control_piecewise_bootstrap$proportion_in_control_signal)

hist(df_piecewise_in_control_piecewise_bootstrap$proportion_in_control_signal, breaks = seq(from = 0, to = 0.45, by = 0.01), probability = T)

ggplot(df_piecewise_in_control_piecewise_bootstrap, aes(x = proportion_in_control_signal, y = after_stat(density))) + 
