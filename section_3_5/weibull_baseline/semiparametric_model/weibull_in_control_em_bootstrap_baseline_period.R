...
list_weibull_in_control_em_bootstrap <- list(threshold_values = store_threshold, proportion_in_control_signal = proportion_signals_in_control_estimated_vs_true)
saveRDS(list_weibull_in_control_em_bootstrap, "section_3_5/weibull_baseline/semiparametric_model/list_weibull_in_control_em_bootstrap_baseline_period.RDS")

# If the simulations have been performed

list_weibull_in_control_em_bootstrap <- readRDS("section_3_5/weibull_baseline/semiparametric_model/list_weibull_in_control_em_bootstrap_baseline_period.RDS")

df_weibull_in_control_em_bootstrap <- data.frame(proportion_in_control_signal = list_weibull_in_control_em_bootstrap$proportion_in_control_signal)

hist(df_weibull_in_control_em_bootstrap$proportion_in_control_signal, breaks = seq(from = 0, to = 0.55, by = 0.01), probability = T)

ggplot(df_weibull_in_control_em_bootstrap, aes(x = proportion_in_control_signal, y = after_stat(density))) + 
