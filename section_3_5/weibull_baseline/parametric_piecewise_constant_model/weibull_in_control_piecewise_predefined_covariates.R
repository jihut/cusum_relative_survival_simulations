...
list_weibull_in_control_piecewise_predefined <- list(threshold_values = store_threshold, proportion_in_control_signal = proportion_signals_in_control_estimated_vs_true)
saveRDS(list_weibull_in_control_piecewise_predefined, "section_3_5/weibull_baseline/parametric_piecewise_constant_model/list_weibull_in_control_piecewise_predefined_covariates.RDS")

# If the simulations have been performed

list_weibull_in_control_piecewise_predefined <- readRDS("section_3_5/weibull_baseline/parametric_piecewise_constant_model/list_weibull_in_control_piecewise_predefined_covariates.RDS")

df_weibull_in_control_piecewise_predefined <- data.frame(proportion_in_control_signal = list_weibull_in_control_piecewise_predefined$proportion_in_control_signal)

hist(df_weibull_in_control_piecewise_predefined$proportion_in_control_signal, breaks = seq(from = 0, to = 0.4, by = 0.01), probability = T)

ggplot(df_weibull_in_control_piecewise_predefined, aes(x = proportion_in_control_signal, y = after_stat(density))) + 
