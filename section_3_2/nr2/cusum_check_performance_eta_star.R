...
saveRDS(max_cusum_matrix, file = "section_3_2/nr2/sim_cusum_check_performance_eta_star.RDS")

# If the simulations has been performed

max_cusum_matrix <- readRDS("section_3_2/nr2/sim_cusum_check_performance_eta_star.RDS")
...
cusum_signal_df <- data.frame(
  eta = rep("eta star = 2.5", nrow(cusum_check_combinations)),
...
saveRDS(cusum_signal_df, "section_3_2/nr2/cusum_signal_df_eta_star.RDS")
