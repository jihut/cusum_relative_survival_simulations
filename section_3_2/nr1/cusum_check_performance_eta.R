...
saveRDS(max_cusum_matrix, file = "section_3_2/nr1/sim_cusum_check_performance_eta.RDS")

# If the simulations has been performed

max_cusum_matrix <- readRDS("section_3_2/nr1/sim_cusum_check_performance_eta.RDS")
...
saveRDS(cusum_signal_df, "section_3_2/nr1/cusum_signal_df_eta_normal.RDS")
