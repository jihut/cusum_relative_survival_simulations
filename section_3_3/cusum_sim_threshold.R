...
system.time(
  max_cusum_matrix <- CUSUMrelsurv::sim_predefined_obs_func_cusum_add_exact_threshold_piecewise_function_parallel(
    sim_obs_func = sim_obs_func,
    n_iterations = 1000,
    n_cores = 8, 
    gamma_vec = c(-0.002, 0.002, 0.005),
...
saveRDS(max_cusum_matrix, "section_3_3/sim_cusum_in_control_samples_for_threshold.RDS")
