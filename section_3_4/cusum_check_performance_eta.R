...
system.time(
  ...
  max_cusum_matrix <- foreach::foreach(
    ...
    for(j in 1:num_of_k_values) {
      ...
      vec_time_excess_sim <- CUSUMrelsurv::vec_excess_sim_acc_time_lin_piecewise_in_and_out_traditional(
...
saveRDS(max_cusum_matrix, file = "section_3_4/sim_cusum_check_performance_eta.RDS")

# If the simulations has been performed

max_cusum_matrix <- readRDS("section_3_4/sim_cusum_check_performance_eta.RDS")
...
saveRDS(cusum_signal_df, "section_3_4/cusum_signal_df_eta_normal.RDS")
