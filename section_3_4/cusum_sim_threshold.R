...
system.time(
  max_cusum_matrix <- CUSUMrelsurv::sim_predefined_obs_func_cusum_acc_time_lin_threshold_piecewise_function_parallel_traditional(
    sim_obs_func = sim_obs_func,
    n_iterations = 1000,
    n_cores = 8, 
    k_vec = c(0.9, 0.95, 1.05, 1.1),
...
saveRDS(max_cusum_matrix, "section_3_4/sim_cusum_in_control_samples_for_threshold.RDS")
